...
const api = "/api/banquet-packages";

export const fetchBanquetPackages = createAsyncThunk<
  { data: BanquetPackage[]; pagination: BanquetPackagePagination },
  BanquetPackageFetchParams | undefined
>(
