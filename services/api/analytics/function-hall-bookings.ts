...
const EMPTY_FUNCTION_HALL_ANALYTICS_RESPONSE: FunctionHallAnalyticsResponse = {
  summary: {
    total_bookings: 0,
    total_revenue: 0,
...
export async function getFunctionHallAnalytics(
  params: FunctionHallAnalyticsParams,
) {
...
export function getEmptyFunctionHallAnalyticsResponse() {
  return EMPTY_FUNCTION_HALL_ANALYTICS_RESPONSE;
}
