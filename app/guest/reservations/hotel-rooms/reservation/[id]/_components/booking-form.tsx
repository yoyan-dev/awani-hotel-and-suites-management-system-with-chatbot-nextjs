      ...
      {!guestId ? (
        ...
        <Form onSubmit={onSubmit} className="flex-1 px-4 w-full space-y-4">
            ...
            {specialRequests ? (
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-300 mb-2">
                  Select optional add-ons for this room. Use the plus/minus
          ...
          {/* <div className="space-y-4">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-300 mb-3">
              Please complete this section honestly. These answers are required
              for your safety and for compliance with health regulations. <br />
            </p>
            <Textarea
