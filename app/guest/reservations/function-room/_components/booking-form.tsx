...
export default function BookingForm({
  ...
  const defaultStartDate = React.useMemo(() => parseDate(minDate.toString()), [minDate]);
  const defaultEndDate = React.useMemo(() => parseDate(minDate.toString()), [minDate]);
  ...
  }, [endDate, endTime.hour, endTime.minute, setEventDuration, startDate, startTime.hour, startTime.minute]);
