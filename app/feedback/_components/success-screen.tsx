...
export default function SuccessScreen() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f4eee3] px-4 dark:bg-[#0f0c08]">
      ...
      <div className="relative w-full max-w-xl rounded-4xl border border-[#deceba] bg-[#fffdf8] p-8 text-center shadow-[0_24px_56px_-38px_rgba(30,22,14,0.5)] sm:p-10 dark:border-[#2a2118] dark:bg-[#15110c]">
