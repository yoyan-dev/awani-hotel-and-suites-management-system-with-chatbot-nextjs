...
export default function BookingDetailsPage() {
  ...
  const handleDownloadPdf = () => {
    ...
    addSection("Booking Overview", [
      ["Booking Number", formatValue(booking.booking_number)],
      ["Status", formatValue(booking.status)],
      ["Booking Source", formatValue(booking.booking_source)],
    ...
    addSection("Additional Details", [
      ["Room Description", formatValue(booking.room_type?.description)],
    ]);
    ...
    addSection("Payment Summary", [
      ...
      ["Balance Due", formatMoneyForPdf(balanceDue)],
    ]);
